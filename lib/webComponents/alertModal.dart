...
class containerStyle{
  ...
  static BoxConstraints customBoxConstraints(BuildContext context) {
      ...
      return BoxConstraints(
        minWidth: 100, maxWidth: 480
      );
      } else {
        return BoxConstraints(
          minWidth: 100, maxWidth: maxWidth
        );
      }
  }
  ...
  static BoxConstraints customBoxConstraints2(BuildContext context) {
      ...
      return BoxConstraints(
        ...
        return BoxConstraints(
          minWidth: 20, maxWidth: maxWidth2
        );
      }
  }
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                      ...
                      children: [
                        Text(widget.title ,style: TextStyle(fontFamily: "quicksand", fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xff707070)), textAlign: TextAlign.right,),
                        SizedBox(height: 25.0),
                        Text(widget.descripcion, style: TextStyle(fontFamily: "quicksand", fontSize: 18.0, fontWeight: FontWeight.normal, color: Color(0xff707070)), textAlign: TextAlign.right),
            ...
            Container(
              padding: EdgeInsets.only(top: 0, left: 0, right: 20, bottom: 20),
              child: Row(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xffC8D3E3),
                      ...
                      child: Text(widget.textoboton1, style: TextStyle(fontFamily: "quicksand", fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xffffffff))  ),
                    ),
                    ...
                    Visibility(
                      ...
                      child: Text(widget.textoboton2, style: TextStyle(fontFamily: "quicksand", fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xffffffff))),
                    ),
                    ),
